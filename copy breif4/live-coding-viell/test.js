    ...
    return function() {
        ...
        2: [function(e, n) {
            n.exports = function(n) {
                ...
                function s(e, t) {
                    const n = o(this.namespace + ("undefined" == typeof t ? ":" : t) + e);
                ...
                ,
                o.disable = function() {
                    const e = [...o.names.map(i), ...o.skips.map(i).map(e => "-" + e)].join(",");
                    return o.enable(""),
                    e
                }
                ,
        ...
        3: [function(e, t) {
            ...
            function s(e, t, n, r) {
                if (t)
                    ...
                    for (var o = e.length, a = f(e, o), s = 0; s < o; ++s)
                        a[s].call(n, r)
            }
            function d(e, t, n, r, o) {
                if (t)
                    ...
                    for (var a = e.length, s = f(e, a), d = 0; d < a; ++d)
                        s[d].call(n, r, o)
            }
            function l(e, t, n, r, o, a) {
                if (t)
                    ...
                    for (var s = e.length, d = f(e, s), l = 0; l < s; ++l)
                        d[l].call(n, r, o, a)
            }
            function p(e, t, n, r) {
                if (t)
            ...
            function u(e, t, n, o) {
                ...
                s = e._events),
                i = s[t]) : (s = e._events = E(null),
                e._eventsCount = 0),
                !i)
                    i = s[t] = n,
                    ++e._eventsCount;
                else if ("function" == typeof i ? i = s[t] = o ? [n, i] : [i, n] : o ? i.unshift(n) : i.push(n),
                !i.warned && (a = r(e),
                a && 0 < a && i.length > a)) {
                    i.warned = !0;
                    ...
                    d.type = t,
                    d.count = i.length,
                    "object" == typeof console && console.warn && console.warn("%s: %s", d.name, d.message)
                }
                return e
            }
            function m() {
            ...
            function h(e, t) {
                for (var r = t, o = r + 1, a = e.length; o < a; r += 1,
                o += 1)
                    e[r] = e[o];
                e.pop()
            }
            ...
            n.prototype.prependOnceListener = function(e, t) {
                if ("function" != typeof t)
                    throw new TypeError("\"listener\" argument must be a function");
                return this.prependListener(e, _(this, e, t)),
                this
            }
            ,
            n.prototype.removeListener = function(e, t) {
                ...
                !n)
                    return this;
                if (n === t || n.listener === t)
                    0 == --this._eventsCount ? this._events = E(null) : (delete r[e],
            ...
            n.prototype.removeAllListeners = function(e) {
                ...
                !n)
                    return this;
                if (!n.removeListener)
                    return 0 === arguments.length ? (this._events = E(null),
                    this._eventsCount = 0) : n[e] && (0 == --this._eventsCount ? this._events = E(null) : delete n[e]),
                    this;
        ...
        4: [function(e, t) {
            function n(e, t) {
                ...
                a[i] = {});
                var d;
                return void 0 !== a[i] && void 0 !== a[i][n] ? d = a[i][n] : (d = a[i][n] = r(),
                "prepend" == n ? s.insertBefore(d, s.childNodes[0]) : s.appendChild(d)),
                65279 === e.charCodeAt(0) && (e = e.substr(1, e.length)),
                d.styleSheet ? d.styleSheet.cssText += e : d.textContent += e,
                d
            }
            function r() {
        ...
        5: [function(e, n) {
            ...
            function o(e) {
                var n = t(e);
                return 86400000 <= n ? i(e / 86400000) + "d" : 3600000 <= n ? i(e / 3600000) + "h" : 60000 <= n ? i(e / 60000) + "m" : 1000 <= n ? i(e / 1000) + "s" : e + "ms"
            }
            function a(e) {
                var n = t(e);
                return 86400000 <= n ? s(e, n, 86400000, "day") : 3600000 <= n ? s(e, n, 3600000, "hour") : 60000 <= n ? s(e, n, 60000, "minute") : 1000 <= n ? s(e, n, 1000, "second") : e + " ms"
            }
            function s(e, t, r, n) {
        ...
        6: [function(e, t) {
            ...
            _.off = p,
            _.removeListener = p,
            _.removeAllListeners = p,
            _.emit = p,
            _.prependListener = p,
            _.prependOnceListener = p,
            _.listeners = function() {
                return []
            }
            ,
            _.binding = function() {
        ...
        7: [function(t, n) {
            const r = t("debug")
              ...
              , l = 2 * d
              , p = 16384
              , u = "undefined" != typeof window && (window.AudioContext || window.webkitAudioContext);
            class m extends o {
                constructor(e="/") {
                    super(),
                    this.destroyed = !1,
                    ...
                    this._songPtr = 0,
                    this._bufferPtr = 0,
                    this._array = new Int16Array(2 * p),
                    this._currentUrlOrBuf = null,
                    this._interval = null,
                    this._startInterval = this._startInterval.bind(this),
                    this._stopInterval = this._stopInterval.bind(this),
                    this._audioContext = new u,
                    this._node = this._audioContext.createScriptProcessor(p, 0, d),
                ...
                _onLibReady() {
                    ...
                    return 0 === e ? void (this._bufferPtr = this._lib._malloc(p * l),
                    i("Initialized libtimidity"),
                    this._ready = !0,
                    this.emit("_ready")) : this._destroy(new Error("Failed to initialize libtimidity"))
                }
                async load(e) {
                    if (s("load %o", e),
                    this.destroyed)
                    ...
                    let t;
                    if ("string" == typeof e) {
                        if (t = await this._fetch(new URL(e,this._baseUrl)),
                        this._currentUrlOrBuf !== e)
                            return;
                ...
                _loadSong(e) {
                    ...
                    return this._lib._mid_istream_close(r),
                    this._lib._free(t),
                    this._lib._free(n),
                    0 === o ? this._destroy(new Error("Failed to load MIDI file")) : o
                }
                async _fetchInstrument(e) {
                    if (this._pendingFetches[e])
                        return this._pendingFetches[e];
                    const t = new URL(e,this._baseUrl)
                      , n = this._fetch(t);
                    this._pendingFetches[e] = n;
                    const r = await n;
                    return this._writeInstrumentFile(e, r),
                ...
                play() {
                    ...
                    this._playing = !0,
                    this._ready && !this._currentUrlOrBuf && (this.emit("playing"),
                    this._startInterval())
                }
                _onAudioProcess(e) {
                    const t = this._songPtr && this._playing ? this._readMidiData() : 0;
                    0 < t && this._currentUrlOrBuf && (this._currentUrlOrBuf = null,
                    this.emit("playing"),
                    this._startInterval());
                    const n = e.outputBuffer.getChannelData(0)
                      , r = e.outputBuffer.getChannelData(1);
                    for (let o = 0; o < t; o++)
                        n[o] = this._array[2 * o] / 32767,
                        r[o] = this._array[2 * o + 1] / 32767;
                    for (let o = t; o < p; o++)
                        n[o] = 0,
                        r[o] = 0;
                    this._songPtr && this._playing && 0 === t && (this.emit("ended"),
                    !this.destroyed && (this.seek(0),
                    this.pause()))
                }
                _readMidiData() {
                    const e = this._lib._mid_song_read_wave(this._songPtr, this._bufferPtr, p * l)
                      , t = e / l;
                    return 0 === t ? 0 : (this._array.set(this._lib.HEAP16.subarray(this._bufferPtr / 2, (this._bufferPtr + e) / 2)),
                    t)
                }
                pause() {
                    if (s("pause"),
                ...
                seek(t) {
                    ...
                    if (this._songPtr) {
                        const n = e(1e3 * t);
                        this._lib._mid_song_seek(this._songPtr, n),
                        this._onTimeupdate()
                    }
                }
                get currentTime() {
                ...
                _destroy(e) {
                    ...
                    this._array = null,
                    this._songPtr && this._destroySong(),
                    this._bufferPtr && (this._lib._free(this._bufferPtr),
                    this._bufferPtr = 0),
            ...
            var s = function() {
                ...
                return function(r) {
                    var H = Math.ceil
                      ...
                      , W = Math.max;
                    function o(e) {
                        return G.locateFile ? G.locateFile(e, X) : X + e
                    }
                    function a(e, t, n) {
                        for (var r = String.fromCharCode, o = t + n, a = t; e[a] && !(a >= o); )
                            ++a;
                        if (16 < a - t && e.subarray && ue)
                            return ue.decode(e.subarray(t, a));
                        for (var s, i = ""; t < a; ) {
                            if (s = e[t++],
                            !(128 & s)) {
                                i += r(s);
                            ...
                            var l = 63 & e[t++];
                            if (s = 224 == (240 & s) ? (15 & s) << 12 | d << 6 | l : (7 & s) << 18 | d << 12 | l << 6 | 63 & e[t++],
                            65536 > s)
                                i += r(s);
                            else {
                                var p = s - 65536;
                    ...
                    function l(e) {
                        for (var t, n = 0, r = 0; r < e.length; ++r)
                            t = e.charCodeAt(r),
                            55296 <= t && 57343 >= t && (t = 65536 + ((1023 & t) << 10) | 1023 & e.charCodeAt(++r)),
                            127 >= t ? ++n : 2047 >= t ? n += 2 : 65535 >= t ? n += 3 : n += 4;
                        return n
                    }
                    function p(e) {
                        return e
                    ...
                    function g() {
                        G.HEAP8 = te = new Int8Array(ee),
                        G.HEAP16 = re = new Int16Array(ee),
                        G.HEAP32 = ae = new Int32Array(ee),
                        G.HEAPU8 = ne = new Uint8Array(ee),
                        G.HEAPU16 = oe = new Uint16Array(ee),
                        G.HEAPU32 = se = new Uint32Array(ee),
                        G.HEAPF32 = ie = new Float32Array(ee),
                        G.HEAPF64 = de = new Float64Array(ee)
                    }
                    function h(e) {
                        for (; 0 < e.length; ) {
                            var t = e.shift();
                            ...
                            var n = t.func;
                            "number" == typeof n ? void 0 === t.arg ? G.dynCall_v(n) : G.dynCall_vi(n, t.arg) : n(void 0 === t.arg ? null : t.arg)
                        }
                    }
                    function f() {
                        if (G.preRun)
                    ...
                    function y() {
                        be = !0,
                        G.noFSInit || Be.init.initialized || Be.init(),
                        Ae.init(),
                        h(fe)
                    }
                    function E() {
                    ...
                    function F() {
                        De++,
                        G.monitorRunDependencies && G.monitorRunDependencies(De)
                    }
                    function D() {
                        if (De--,
                        G.monitorRunDependencies && G.monitorRunDependencies(De),
                        0 == De && (null !== we && (clearInterval(we),
                        we = null),
                        Se)) {
                            var e = Se;
                            Se = null,
                    ...
                    function w(e) {
                        ...
                        return t.startsWith ? e.startsWith("data:application/octet-stream;base64,") : 0 === e.indexOf("data:application/octet-stream;base64,")
                    }
                    function S() {
                        try {
                            if (G.wasmBinary)
                    ...
                    function T() {
                        return G.wasmBinary || 0 || "function" != typeof fetch ? new Promise(function(e) {
                            e(S())
                        }
                        ) : fetch(Te, {
                            credentials: "same-origin"
                    ...
                    function P(e) {
                        ...
                        function o() {
                            return G.wasmBinary || "function" != typeof WebAssembly.instantiateStreaming || w(Te) || "function" != typeof fetch ? r(n) : void fetch(Te, {
                                credentials: "same-origin"
                            }).then(function(e) {
                        ...
                        if (F("wasm-instantiate"),
                        G.instantiateWasm)
                            try {
                                return G.instantiateWasm(a, t)
                            } catch (t) {
                                return $("Module.instantiateWasm callback failed with error: " + t),
                                !1
                            }
                        return o(),
                        {}
                    ...
                    function x(e) {
                        return G.___errno_location && (ae[G.___errno_location() >> 2] = e),
                        e
                    }
                    function A(e, t) {
                        Re.varargs = t;
                        try {
                            var n = Re.getStreamFromFD()
                              , r = Re.get()
                              , o = Re.get()
                              , a = Re.get()
                              , s = Re.get()
                              , i = r * 4294967296 + (o >>> 0)
                              , d = 9007199254740992;
                            return i <= -d || i >= d ? -75 : (Be.llseek(n, i, s),
                            tempI64 = [n.position >>> 0, (tempDouble = n.position,
                            1 <= +ke(tempDouble) ? 0 < tempDouble ? (0 | Fe(+ve(tempDouble / 4294967296), 4294967295)) >>> 0 : ~~+Ce((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)],
                            ae[a >> 2] = tempI64[0],
                            ae[a + 4 >> 2] = tempI64[1],
                            n.getdents && 0 === i && 0 === s && (n.getdents = null),
                            0)
                        } catch (t) {
                            return "undefined" != typeof Be && t instanceof Be.ErrnoError || j(t),
                            -t.errno
                        }
                    }
                    function L(e, t) {
                            ...
                            case 0:
                                {
                                    ...
                                    if (0 > o)
                                        return -22;
                                    var a;
                                    return a = Be.open(n.path, n.flags, 0, o),
                                    a.fd
                                }
                            case 1:
                            case 2:
                    ...
                    function M(e, t, n) {
                        ne.set(ne.subarray(t, t + n), e)
                    }
                    function O(e) {
                        e = c(e, 65536);
                        var t = ee.byteLength;
                        try {
                            var n = Z.grow((e - t) / 65536);
                            return -1 !== n && (ee = Z.buffer,
                            !0)
                        } catch (t) {
                            return !1
                        }
                    ...
                    function I(e) {
                        ...
                        (e = e || G.arguments,
                        !(0 < De)) && (f(),
                        0 < De || G.calledRun || (G.setStatus ? (G.setStatus("Running..."),
                        setTimeout(function() {
                            setTimeout(function() {
                                G.setStatus("")
                            }, 1),
                    ...
                    r = r || {};
                    var q, G = "undefined" == typeof r ? {} : r, K = {};
                    for (q in G)
                        G.hasOwnProperty(q) && (K[q] = G[q]);
                    G.arguments = [],
                    ...
                    ,
                    G.setWindowTitle = function(e) {
                        document.title = e
                    }
                    ;
                    var Y = G.print || ("undefined" == typeof console ? "undefined" == typeof print ? null : print : console.log.bind(console))
                      , $ = G.printErr || ("undefined" == typeof printErr ? "undefined" != typeof console && console.warn.bind(console) || Y : printErr);
                    for (q in K)
                        K.hasOwnProperty(q) && (G[q] = K[q]);
                    K = void 0;
                    var J = {
                    ...
                    var Z, Q, ee, te, ne, re, oe, ae, se, ie, de, le = !1, pe = 0, ue = "undefined" == typeof TextDecoder ? void 0 : new TextDecoder("utf8"), me = "undefined" == typeof TextDecoder ? void 0 : new TextDecoder("utf-16le"), _e = 10848, ce = 5242880, ge = G.TOTAL_MEMORY || 16777216;
                    ge < ce && $("TOTAL_MEMORY should be larger than TOTAL_STACK, was " + ge + "! (TOTAL_STACK=" + ce + ")"),
                    G.buffer ? ee = G.buffer : "object" == typeof WebAssembly && "function" == typeof WebAssembly.Memory ? (Z = new WebAssembly.Memory({
                        initial: ge / 65536
                    }),
                    ee = Z.buffer) : ee = new ArrayBuffer(ge),
                    g(),
                    ae[_e >> 2] = 5253760;
                    var he = []
                      , fe = []
                    ...
                    G.preloadedImages = {},
                    G.preloadedAudios = {};
                    var Te = "libtimidity.wasm";
                    w(Te) || (Te = o(Te)),
                    G.asm = function(e, t) {
                        t.memory = Z,
                        t.table = Q = new WebAssembly.Table({
                            initial: 24,
                            maximum: 24,
                            element: "anyfunc"
                        }),
                    ...
                    var Pe = {
                        ...
                        normalizeArray: function(e, t) {
                            for (var n, r = 0, o = e.length - 1; 0 <= o; o--)
                                n = e[o],
                                "." === n ? e.splice(o, 1) : ".." === n ? (e.splice(o, 1),
                                r++) : r && (e.splice(o, 1),
                                r--);
                            if (t)
                                for (; r; r--)
                        ...
                        normalize: function(e) {
                            var t = "/" === e.charAt(0)
                              , n = "/" === e.substr(-1);
                            return e = Pe.normalizeArray(e.split("/").filter(function(e) {
                                return !!e
                            }), !t).join("/"),
                            e || t || (e = "."),
                            e && n && (e += "/"),
                        ...
                        join2: function(e, t) {
                            return Pe.normalize(e + "/" + t)
                        }
                    }
                      , xe = {
                        resolve: function() {
                            for (var e, t = "", n = !1, r = arguments.length - 1; -1 <= r && !n; r--) {
                                if (e = 0 <= r ? arguments[r] : Be.cwd(),
                                "string" != typeof e)
                            ...
                            return t = Pe.normalizeArray(t.split("/").filter(function(e) {
                                return !!e
                            }), !n).join("/"),
                            (n ? "/" : "") + t || "."
                        },
                        relative: function(e, t) {
                            ...
                            e = xe.resolve(e).substr(1),
                            t = xe.resolve(t).substr(1);
                            for (var r = n(e.split("/")), o = n(t.split("/")), a = U(r.length, o.length), s = a, d = 0; d < a; d++)
                                if (r[d] !== o[d]) {
                                    s = d;
                                    break
                                }
                            for (var l = [], d = s; d < r.length; d++)
                                l.push("..");
                      ...
                      , Ae = {
                        ...
                        register: function(e, t) {
                            ...
                            Be.registerDevice(e, Ae.stream_ops)
                        },
                        stream_ops: {
                            open: function(e) {
                            ...
                            write: function(e, t, n, r) {
                                ...
                                try {
                                    for (var o = 0; o < r; o++)
                                        e.tty.ops.put_char(e.tty, t[n + o])
                                } catch (t) {
                                    throw new Be.ErrnoError(5)
                                }
                        ...
                        default_tty_ops: {
                            ...
                            put_char: function(e, t) {
                                null === t || 10 === t ? (Y(a(e.output, 0)),
                                e.output = []) : 0 != t && e.output.push(t)
                            },
                            flush: function(e) {
                                e.output && 0 < e.output.length && (Y(a(e.output, 0)),
                                e.output = [])
                            }
                        },
                        default_tty1_ops: {
                            put_char: function(e, t) {
                                null === t || 10 === t ? ($(a(e.output, 0)),
                                e.output = []) : 0 != t && e.output.push(t)
                            },
                            flush: function(e) {
                                e.output && 0 < e.output.length && ($(a(e.output, 0)),
                                e.output = [])
                            }
                        }
                    }
                      , Le = {
                        ...
                        createNode: function(e, t, n, r) {
                            if (Be.isBlkdev(n) || Be.isFIFO(n))
                                throw new Be.ErrnoError(1);
                            Le.ops_table || (Le.ops_table = {
                                dir: {
                                    node: {
                            ...
                            var o = Be.createNode(e, t, n, r);
                            return Be.isDir(o.mode) ? (o.node_ops = Le.ops_table.dir.node,
                            o.stream_ops = Le.ops_table.dir.stream,
                            o.contents = {}) : Be.isFile(o.mode) ? (o.node_ops = Le.ops_table.file.node,
                            o.stream_ops = Le.ops_table.file.stream,
                            o.usedBytes = 0,
                            o.contents = null) : Be.isLink(o.mode) ? (o.node_ops = Le.ops_table.link.node,
                            o.stream_ops = Le.ops_table.link.stream) : Be.isChrdev(o.mode) && (o.node_ops = Le.ops_table.chrdev.node,
                        ...
                        expandFileStorage: function(e, t) {
                            ...
                            if (!(n >= t)) {
                                t = W(t, 0 | n * (1048576 > n ? 2 : 1.125)),
                                0 != n && (t = W(t, 256));
                                var r = e.contents;
                                return e.contents = new Uint8Array(t),
                                void (0 < e.usedBytes && e.contents.set(r.subarray(0, e.usedBytes), 0))
                            }
                        },
                        resizeFileStorage: function(e, t) {
                            if (e.usedBytes != t) {
                                ...
                                if (!e.contents || e.contents.subarray) {
                                    ...
                                    n && e.contents.set(n.subarray(0, U(t, e.usedBytes))),
                                    void (e.usedBytes = t)
                                }
                        ...
                        node_ops: {
                            getattr: function(e) {
                                var t = {};
                                return t.dev = Be.isChrdev(e.mode) ? e.id : 1,
                                t.ino = e.id,
                                t.mode = e.mode,
                                t.nlink = 1,
                                t.uid = 0,
                            ...
                            symlink: function(e, t, n) {
                                var r = Le.createNode(e, t, 41471, 0);
                                return r.link = n,
                                r
                            },
                            readlink: function(e) {
                        ...
                        stream_ops: {
                            read: function(e, t, n, r, o) {
                                ...
                                if (o >= e.node.usedBytes)
                                    return 0;
                                var s = U(e.node.usedBytes - o, r);
                                if (8 < s && a.subarray)
                                    t.set(a.subarray(o, o + s), n);
                                else
                                    for (var d = 0; d < s; d++)
                                        t[n + d] = a[o + d];
                                return s
                            ...
                            write: function(e, t, n, r, o, a) {
                                ...
                                t.subarray && (!s.contents || s.contents.subarray)) {
                                    if (a)
                                        return s.contents = t.subarray(n, n + r),
                                        s.usedBytes = r,
                                        r;
                                    if (0 === s.usedBytes && 0 === o)
                                        return s.contents = new Uint8Array(t.subarray(n, n + r)),
                                        s.usedBytes = r,
                                        r;
                                    if (o + r <= s.usedBytes)
                                        return s.contents.set(t.subarray(n, n + r), o),
                                        r
                                }
                                if (Le.expandFileStorage(s, o + r),
                                s.contents.subarray && t.subarray)
                                    s.contents.set(t.subarray(n, n + r), o);
                                else
                                    for (var d = 0; d < r; d++)
                                        s.contents[o + d] = t[n + d];
                                return s.usedBytes = W(s.usedBytes, o + r),
                                r
                            },
                            llseek: function(e, t, n) {
                                var r = t;
                                if (1 === n ? r += e.position : 2 == n && Be.isFile(e.node.mode) && (r += e.node.usedBytes),
                                0 > r)
                                    throw new Be.ErrnoError(22);
                                return r
                            },
                            allocate: function(e, t, n) {
                                Le.expandFileStorage(e.node, t + n),
                                e.node.usedBytes = W(e.node.usedBytes, t + n)
                            },
                            mmap: function(e, t, n, r, o, a, s) {
                                if (!Be.isFile(e.node.mode))
                                    throw new Be.ErrnoError(19);
                                var i, d, l = e.node.contents;
                                if (!(2 & s) && (l.buffer === t || l.buffer === t.buffer))
                                    d = !1,
                                    i = l.byteOffset;
                                else {
                                    if ((0 < o || o + r < e.node.usedBytes) && (l.subarray ? l = l.subarray(o, o + r) : l = Array.prototype.slice.call(l, o, o + r)),
                                    d = !0,
                                    i = ze(r),
                                    !i)
                            ...
                            msync: function(e, t, n, r, o) {
                                ...
                                if (2 & o)
                                    return 0;
                                Le.stream_ops.write(e, t, 0, r, n, !1);
                                return 0
                            }
                        }
                    }
                      , Be = {
                        ...
                        handleFSError: function(t) {
                            if (!(t instanceof Be.ErrnoError))
                                throw t + " : " + _();
                            return x(t.errno)
                        },
                        lookupPath: function(e, t) {
                            if (e = xe.resolve(Be.cwd(), e),
                            t = t || {},
                            !e)
                                return {
                                    path: "",
                            ...
                            for (var r in n)
                                void 0 === t[r] && (t[r] = n[r]);
                            if (8 < t.recurse_count)
                                throw new Be.ErrnoError(40);
                            for (var o, a = Pe.normalizeArray(e.split("/").filter(function(e) {
                                return !!e
                            }), !1), s = Be.root, d = "/", l = 0; l < a.length && (o = l == a.length - 1,
                            !(o && t.parent)); l++)
                                if (s = Be.lookupNode(s, a[l]),
                                d = Pe.join2(d, a[l]),
                                Be.isMountpoint(s) && (!o || o && t.follow_mount) && (s = s.mounted.root),
                                !o || t.follow)
                                    for (var p, u = 0; Be.isLink(s.mode); ) {
                                        p = Be.readlink(d),
                                        d = xe.resolve(Pe.dirname(d), p);
                                        var m = Be.lookupPath(d, {
                        ...
                        hashName: function(e, t) {
                            for (var n = 0, r = 0; r < t.length; r++)
                                n = 0 | (n << 5) - n + t.charCodeAt(r);
                            return (e + n >>> 0) % Be.nameTable.length
                        },
                        hashAddNode: function(e) {
                            var t = Be.hashName(e.parent.id, e.name);
                            e.name_next = Be.nameTable[t],
                            Be.nameTable[t] = e
                        },
                        hashRemoveNode: function(e) {
                            var t = Be.hashName(e.parent.id, e.name);
                            if (Be.nameTable[t] === e)
                                Be.nameTable[t] = e.name_next;
                            else
                                for (var n = Be.nameTable[t]; n; ) {
                                    if (n.name_next === e) {
                        ...
                        lookupNode: function(e, t) {
                            var n = Be.mayLookup(e);
                            if (n)
                                throw new Be.ErrnoError(n,e);
                            for (var r, o = Be.hashName(e.id, t), a = Be.nameTable[o]; a; a = a.name_next)
                                if (r = a.name,
                                a.parent.id === e.id && r === t)
                                    return a;
                            return Be.lookup(e, t)
                        },
                        createNode: function(e, t, n, r) {
                            if (!Be.FSNode) {
                                Be.FSNode = function(e, t, n, r) {
                                    e || (e = this),
                                    this.parent = e,
                                    this.mount = e.mount,
                                    this.mounted = null,
                            ...
                            var a = new Be.FSNode(e,t,n,r);
                            return Be.hashAddNode(a),
                            a
                        },
                        ...
                        nodePermissions: function(e, t) {
                            return Be.ignorePermissions ? 0 : -1 === t.indexOf("r") || 292 & e.mode ? -1 === t.indexOf("w") || 146 & e.mode ? -1 === t.indexOf("x") || 73 & e.mode ? 0 : 13 : 13 : 13
                        },
                        mayLookup: function(e) {
                            var t = Be.nodePermissions(e, "x");
                            return t ? t : e.node_ops.lookup ? 0 : 13
                        },
                        ...
                        mayDelete: function(e, t, n) {
                            ...
                            if (n) {
                                if (!Be.isDir(r.mode))
                                    return 20;
                                if (Be.isRoot(r) || Be.getPath(r) === Be.cwd())
                                    return 16
                            } else if (Be.isDir(r.mode))
                                return 21;
                            return 0
                        },
                        mayOpen: function(e, t) {
                            return e ? Be.isLink(e.mode) ? 40 : Be.isDir(e.mode) && ("r" !== Be.flagsToPermissionString(t) || 512 & t) ? 21 : Be.nodePermissions(e, Be.flagsToPermissionString(t)) : 2
                        },
                        MAX_OPEN_FDS: 4096,
                        nextfd: function(e, t) {
                            e = e || 0,
                        ...
                        createStream: function(e, t, n) {
                            Be.FSStream || (Be.FSStream = function() {}
                            ,
                        ...
                        chrdev_stream_ops: {
                            open: function(e) {
                                var t = Be.getDevice(e.node.rdev);
                        ...
                        getMounts: function(e) {
                            for (var t, n = [], r = [e]; r.length; )
                                t = r.pop(),
                                n.push(t),
                                r.push.apply(r, t.mounts);
                            return n
                        },
                        syncfs: function(e, t) {
                            function n(e) {
                                return Be.syncFSRequests--,
                                t(e)
                            }
                            function r(e) {
                                return e ? r.errored ? void 0 : (r.errored = !0,
                                n(e)) : void (++a >= o.length && n(null))
                            }
                            "function" == typeof e && (t = e,
                            e = !1),
                            Be.syncFSRequests++,
                            1 < Be.syncFSRequests && console.log("warning: " + Be.syncFSRequests + " FS.syncfs operations in flight at once, probably just doing extra work");
                            var o = Be.getMounts(Be.root.mount)
                              , a = 0;
                        ...
                        mount: function(e, t, n) {
                            ...
                            return d.mount = i,
                            i.root = d,
                            o ? Be.root = d : r && (r.mounted = i,
                            r.mount && r.mount.mounts.push(i)),
                            d
                        },
                        unmount: function(e) {
                            var t = Be.lookupPath(e, {
                                follow_mount: !1
                            });
                            if (!Be.isMountpoint(t.node))
                                throw new Be.ErrnoError(22);
                            var n = t.node
                              , r = n.mounted
                              , o = Be.getMounts(r);
                            Object.keys(Be.nameTable).forEach(function(e) {
                                for (var t, n = Be.nameTable[e]; n; )
                                    t = n.name_next,
                                    -1 !== o.indexOf(n.mount) && Be.destroyNode(n),
                                    n = t
                            }),
                            n.mounted = null;
                        ...
                        mknod: function(e, t, n) {
                            ...
                            if (!a || "." === a || ".." === a)
                                throw new Be.ErrnoError(22);
                            var s = Be.mayCreate(o, a);
                            if (s)
                                throw new Be.ErrnoError(s);
                            if (!o.node_ops.mknod)
                                throw new Be.ErrnoError(1);
                            return o.node_ops.mknod(o, a, t, n)
                        },
                        create: function(e, t) {
                            return t = void 0 === t ? 438 : t,
                            t &= 4095,
                            t |= 32768,
                            Be.mknod(e, t, 0)
                        },
                        mkdir: function(e, t) {
                            return t = void 0 === t ? 511 : t,
                            t &= 1023,
                            t |= 16384,
                            Be.mknod(e, t, 0)
                        },
                        ...
                        symlink: function(e, t) {
                            ...
                            var o = Pe.basename(t)
                              , a = Be.mayCreate(r, o);
                            if (a)
                                throw new Be.ErrnoError(a);
                            if (!r.node_ops.symlink)
                                throw new Be.ErrnoError(1);
                            return r.node_ops.symlink(r, o, e)
                        },
                        rename: function(t, n) {
                            var r, o, a, s = Pe.dirname(t), i = Pe.dirname(n), d = Pe.basename(t), l = Pe.basename(n);
                            try {
                                r = Be.lookupPath(t, {
                                    parent: !0
                                }),
                            ...
                            if (!o || !a)
                                throw new Be.ErrnoError(2);
                            if (o.mount !== a.mount)
                                throw new Be.ErrnoError(18);
                            var p = Be.lookupNode(o, d)
                              , u = xe.relative(t, i);
                            if ("." !== u.charAt(0))
                                throw new Be.ErrnoError(22);
                            if (u = xe.relative(n, s),
                            "." !== u.charAt(0))
                                throw new Be.ErrnoError(39);
                            var m;
                            try {
                            ...
                            if (p !== m) {
                                var _ = Be.isDir(p.mode)
                                  , c = Be.mayDelete(o, d, _);
                                if (c)
                                    throw new Be.ErrnoError(c);
                                if (c = m ? Be.mayDelete(a, l, _) : Be.mayCreate(a, l),
                                c)
                                    throw new Be.ErrnoError(c);
                                if (!o.node_ops.rename)
                                    throw new Be.ErrnoError(1);
                                if (Be.isMountpoint(p) || m && Be.isMountpoint(m))
                                    throw new Be.ErrnoError(16);
                                if (a !== o && (c = Be.nodePermissions(o, "w"),
                                c))
                                    throw new Be.ErrnoError(c);
                                try {
                                    Be.trackingDelegate.willMovePath && Be.trackingDelegate.willMovePath(t, n)
                                } catch (r) {
                                    console.log("FS.trackingDelegate['willMovePath']('" + t + "', '" + n + "') threw an exception: " + r.message)
                                }
                                Be.hashRemoveNode(p);
                                try {
                                ...
                                try {
                                    Be.trackingDelegate.onMovePath && Be.trackingDelegate.onMovePath(t, n)
                                } catch (r) {
                                    console.log("FS.trackingDelegate['onMovePath']('" + t + "', '" + n + "') threw an exception: " + r.message)
                                }
                            }
                        },
                        rmdir: function(t) {
                            var n = Be.lookupPath(t, {
                              ...
                              , o = Pe.basename(t)
                              , a = Be.lookupNode(r, o)
                              , s = Be.mayDelete(r, o, !0);
                            if (s)
                                throw new Be.ErrnoError(s);
                            if (!r.node_ops.rmdir)
                                throw new Be.ErrnoError(1);
                            if (Be.isMountpoint(a))
                                throw new Be.ErrnoError(16);
                            try {
                                Be.trackingDelegate.willDeletePath && Be.trackingDelegate.willDeletePath(t)
                            } catch (n) {
                                console.log("FS.trackingDelegate['willDeletePath']('" + t + "') threw an exception: " + n.message)
                            }
                            r.node_ops.rmdir(r, o),
                            Be.destroyNode(a);
                            try {
                                Be.trackingDelegate.onDeletePath && Be.trackingDelegate.onDeletePath(t)
                            } catch (n) {
                                console.log("FS.trackingDelegate['onDeletePath']('" + t + "') threw an exception: " + n.message)
                            }
                        },
                        readdir: function(e) {
                            var t = Be.lookupPath(e, {
                        ...
                        readlink: function(e) {
                            ...
                            if (!n.node_ops.readlink)
                                throw new Be.ErrnoError(22);
                            return xe.resolve(Be.getPath(n.parent), n.node_ops.readlink(n))
                        },
                        stat: function(e, t) {
                            var n = Be.lookupPath(e, {
                                follow: !t
                            })
                              , r = n.node;
                            if (!r)
                        ...
                        fchmod: function(e, t) {
                            ...
                            if (!n)
                                throw new Be.ErrnoError(9);
                            Be.chmod(n.node, t)
                        },
                        chown: function(e, t, n, r) {
                            var o;
                            if ("string" == typeof e) {
                                var a = Be.lookupPath(e, {
                                    follow: !r
                                });
                                o = a.node
                            } else
                        ...
                        truncate: function(e, t) {
                            ...
                            if (!n.node_ops.setattr)
                                throw new Be.ErrnoError(1);
                            if (Be.isDir(n.mode))
                                throw new Be.ErrnoError(21);
                            if (!Be.isFile(n.mode))
                                throw new Be.ErrnoError(22);
                            var o = Be.nodePermissions(n, "w");
                            if (o)
                                throw new Be.ErrnoError(o);
                        ...
                        open: function(t, n, r, o, a) {
                            if ("" === t)
                                throw new Be.ErrnoError(2);
                            n = "string" == typeof n ? Be.modeStringToFlags(n) : n,
                            r = "undefined" == typeof r ? 438 : r,
                            r = 64 & n ? 32768 | 4095 & r : 0;
                            var s;
                            if ("object" == typeof t)
                                s = t;
                            else {
                            ...
                            if (64 & n)
                                if (!s)
                                    ...
                                    throw new Be.ErrnoError(17);
                            if (!s)
                                throw new Be.ErrnoError(2);
                            if (Be.isChrdev(s.mode) && (n &= -513),
                            65536 & n && !Be.isDir(s.mode))
                                throw new Be.ErrnoError(20);
                            if (!d) {
                                var l = Be.mayOpen(s, n);
                                if (l)
                                    throw new Be.ErrnoError(l)
                            }
                            512 & n && Be.truncate(s, 0),
                            n &= -641;
                            var p = Be.createStream({
                                node: s,
                                path: Be.getPath(s),
                                flags: n,
                                seekable: !0,
                            ...
                            G.logReadFiles && !(1 & n) && (!Be.readFiles && (Be.readFiles = {}),
                            !(t in Be.readFiles) && (Be.readFiles[t] = 1,
                            console.log("FS.trackingDelegate error on read file: " + t)));
                            try {
                                if (Be.trackingDelegate.onOpenFile) {
                                    var u = 0;
                                    1 != (2097155 & n) && (u |= Be.tracking.openFlags.READ),
                                    0 != (2097155 & n) && (u |= Be.tracking.openFlags.WRITE),
                                    Be.trackingDelegate.onOpenFile(t, u)
                                }
                            } catch (n) {
                                console.log("FS.trackingDelegate['onOpenFile']('" + t + "', flags) threw an exception: " + n.message)
                            }
                            return p
                        },
                        close: function(e) {
                        ...
                        write: function(t, n, r, o, a, s) {
                            ...
                            if (0 == (2097155 & t.flags))
                                throw new Be.ErrnoError(9);
                            if (Be.isDir(t.node.mode))
                                throw new Be.ErrnoError(21);
                            if (!t.stream_ops.write)
                                throw new Be.ErrnoError(22);
                            1024 & t.flags && Be.llseek(t, 0, 2);
                            ...
                            i || (t.position += d);
                            try {
                                t.path && Be.trackingDelegate.onWriteToFile && Be.trackingDelegate.onWriteToFile(t.path)
                            } catch (n) {
                                console.log("FS.trackingDelegate['onWriteToFile']('" + t.path + "') threw an exception: " + n.message)
                            }
                            return d
                        },
                        allocate: function(e, t, n) {
                            ...
                            if (!e.stream_ops.allocate)
                                throw new Be.ErrnoError(95);
                            e.stream_ops.allocate(e, t, n)
                        },
                        mmap: function(e, t, n, r, o, a, s) {
                            if (0 != (2 & a) && 0 == (2 & s) && 2 != (2097155 & e.flags))
                                throw new Be.ErrnoError(13);
                            if (1 == (2097155 & e.flags))
                                throw new Be.ErrnoError(13);
                            if (!e.stream_ops.mmap)
                                throw new Be.ErrnoError(19);
                            return e.stream_ops.mmap(e, t, n, r, o, a, s)
                        },
                        msync: function(e, t, n, r, o) {
                        ...
                        readFile: function(e, t) {
                            ...
                            var n, r = Be.open(e, t.flags), o = Be.stat(e), s = o.size, i = new Uint8Array(s);
                            return Be.read(r, i, 0, s, 0),
                            "utf8" === t.encoding ? n = a(i, 0) : "binary" === t.encoding && (n = i),
                            Be.close(r),
                            n
                        },
                        writeFile: function(e, t, n) {
                            n = n || {},
                            n.flags = n.flags || "w";
                            var r = Be.open(e, n.flags, n.mode);
                            if ("string" == typeof t) {
                                var o = new Uint8Array(l(t) + 1)
                                  , a = i(t, o, 0, o.length);
                                Be.write(r, o, 0, a, void 0, n.canOwn)
                            } else if (ArrayBuffer.isView(t))
                                Be.write(r, t, 0, t.byteLength, void 0, n.canOwn);
                            else
                        ...
                        chdir: function(e) {
                            ...
                            if (!Be.isDir(t.node.mode))
                                throw new Be.ErrnoError(20);
                            var n = Be.nodePermissions(t.node, "x");
                            if (n)
                                throw new Be.ErrnoError(n);
                            Be.currentPath = t.path
                        },
                        createDefaultDirectories: function() {
                            Be.mkdir("/tmp"),
                            Be.mkdir("/home"),
                            Be.mkdir("/home/web_user")
                        },
                        createDefaultDevices: function() {
                            ...
                            Ae.register(Be.makedev(5, 0), Ae.default_tty_ops),
                            Ae.register(Be.makedev(6, 0), Ae.default_tty1_ops),
                        ...
                        createStandardStreams: function() {
                            G.stdin ? Be.createDevice("/dev", "stdin", G.stdin) : Be.symlink("/dev/tty", "/dev/stdin"),
                            G.stdout ? Be.createDevice("/dev", "stdout", null, G.stdout) : Be.symlink("/dev/tty", "/dev/stdout"),
                            G.stderr ? Be.createDevice("/dev", "stderr", null, G.stderr) : Be.symlink("/dev/tty1", "/dev/stderr");
                            var e = Be.open("/dev/stdin", "r")
                              , t = Be.open("/dev/stdout", "w")
                              , n = Be.open("/dev/stderr", "w")
                        },
                        ensureErrnoError: function() {
                            Be.ErrnoError || (Be.ErrnoError = function(e, t) {
                                this.node = t,
                        ...
                        quit: function() {
                            ...
                            var e = G._fflush;
                            e && e(0);
                            for (var t, n = 0; n < Be.streams.length; n++)
                                (t = Be.streams[n],
                                !!t) && Be.close(t)
                        },
                        ...
                        findObject: function(e, t) {
                            var n = Be.analyzePath(e, t);
                            return n.exists ? n.object : (x(n.error),
                            null)
                        },
                        ...
                        createFolder: function(e, t, n, r) {
                            var o = Pe.join2("string" == typeof e ? e : Be.getPath(e), t)
                              , a = Be.getMode(n, r);
                            return Be.mkdir(o, a)
                        },
                        ...
                        createFile: function(e, t, n, r, o) {
                            var a = Pe.join2("string" == typeof e ? e : Be.getPath(e), t)
                              , s = Be.getMode(r, o);
                            return Be.create(a, s)
                        },
                        createDataFile: function(e, t, n, r, o, a) {
                            var s = t ? Pe.join2("string" == typeof e ? e : Be.getPath(e), t) : e
                              , d = Be.getMode(r, o)
                              , l = Be.create(s, d);
                            if (n) {
                                if ("string" == typeof n) {
                                    for (var p = Array(n.length), u = 0, m = n.length; u < m; ++u)
                                        p[u] = n.charCodeAt(u);
                                    n = p
                                }
                                Be.chmod(l, 146 | d);
                                var _ = Be.open(l, "w");
                                Be.write(_, n, 0, n.length, 0, a),
                                Be.close(_),
                                Be.chmod(l, d)
                            }
                            return l
                        ...
                        createDevice: function(e, t, n, r) {
                            ...
                            var s = Be.makedev(Be.createDevice.major++, 0);
                            return Be.registerDevice(s, {
                                open: function(e) {
                                    e.seekable = !1
                                },
                                close: function() {
                        ...
                        createLink: function(e, t, n) {
                            var r = Pe.join2("string" == typeof e ? e : Be.getPath(e), t);
                            return Be.symlink(n, r)
                        },
                        ...
                        createLazyFile: function(e, t, n, r, o) {
                            ...
                            a.prototype.cacheLength = function() {
                                ...
                                var t, r = +e.getResponseHeader("Content-length"), o = (t = e.getResponseHeader("Accept-Ranges")) && "bytes" === t, a = (t = e.getResponseHeader("Content-Encoding")) && "gzip" === t, s = 1048576;
                                o || (s = r);
                                var i = function(e, t) {
                                    if (e > t)
                                    ...
                                    if (o.open("GET", n, !1),
                                    r !== s && o.setRequestHeader("Range", "bytes=" + e + "-" + t),
                                    ...
                                    return void 0 === o.response ? N(o.responseText || "", !0) : new Uint8Array(o.response || [])
                                }
                                  , d = this;
                                d.setDataGetter(function(e) {
                                    var t = e * s
                                      , n = (e + 1) * s - 1;
                                    if (n = U(n, r - 1),
                                    "undefined" == typeof d.chunks[e] && (d.chunks[e] = i(t, n)),
                                    "undefined" == typeof d.chunks[e])
                            ...
                            var d = Be.createFile(e, t, i, r, o);
                            i.contents ? d.contents = i.contents : i.url && (d.contents = null,
                            d.url = i.url),
                            ...
                            var l = {}
                              , p = Object.keys(d.stream_ops);
                            return p.forEach(function(e) {
                                var t = d.stream_ops[e];
                                l[e] = function() {
                                    if (!Be.forceLoadFile(d))
                                        throw new Be.ErrnoError(5);
                        ...
                        createPreloadedFile: function(e, t, n, r, o, a, s, i, d, l) {
                            function p(n) {
                                function p(n) {
                                    l && l(),
                                    i || Be.createDataFile(e, t, n, r, o, d),
                                    a && a(),
                                    D(m)
                                }
                                var _ = !1;
                                G.preloadPlugins.forEach(function(e) {
                                    _ || e.canHandle(u) && (e.handle(n, u, p, function() {
                                        s && s(),
                                        D(m)
                                    }),
                                    _ = !0)
                            ...
                            Browser.init();
                            var u = t ? xe.resolve(Pe.join2(e, t)) : e
                              , m = v("cp " + u);
                            F(m),
                        ...
                        saveFilesToDB: function(e, t, n) {
                            ...
                            var r = Be.indexedDB();
                            try {
                                var o = r.open(Be.DB_NAME(), Be.DB_VERSION)
                            } catch (t) {
                                return n(t)
                            }
                            o.onupgradeneeded = function() {
                                ...
                                var e = o.result;
                                e.createObjectStore(Be.DB_STORE_NAME)
                            }
                            ,
                            o.onsuccess = function() {
                                ...
                                var a = o.result
                                  , s = a.transaction([Be.DB_STORE_NAME], "readwrite")
                                  , i = s.objectStore(Be.DB_STORE_NAME)
                                  , d = 0
                                  , l = 0
                                  , p = e.length;
                                e.forEach(function(e) {
                                    var t = i.put(Be.analyzePath(e).object.contents, e);
                        ...
                        loadFilesFromDB: function(e, t, n) {
                            ...
                            o.onsuccess = function() {
                                ...
                                var a = o.result;
                                try {
                                    var s = a.transaction([Be.DB_STORE_NAME], "readonly")
                                } catch (t) {
                                    return void n(t)
                                }
                                var i = s.objectStore(Be.DB_STORE_NAME)
                                  , d = 0
                                  , l = 0
                                  , p = e.length;
                                e.forEach(function(e) {
                                    ...
                                    t.onsuccess = function() {
                                        ...
                                        Be.createDataFile(Pe.dirname(e), Pe.basename(e), t.result, !0, !0, !0),
                                        d++,
                                        d + l == p && r()
                                    }
                                    ,
                      ...
                      , Re = {
                        ...
                        doStat: function(e, t, n) {
                            try {
                                ...
                                if (n && n.node && Pe.normalize(t) !== Pe.normalize(Be.getPath(n.node)))
                                    return -20;
                                throw n
                            }
                            return ae[n >> 2] = r.dev,
                            ...
                            ae[n + 28 >> 2] = r.rdev,
                            ae[n + 32 >> 2] = 0,
                            tempI64 = [r.size >>> 0, (tempDouble = r.size,
                            1 <= +ke(tempDouble) ? 0 < tempDouble ? (0 | Fe(+ve(tempDouble / 4294967296), 4294967295)) >>> 0 : ~~+Ce((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)],
                            ae[n + 40 >> 2] = tempI64[0],
                            ae[n + 44 >> 2] = tempI64[1],
                            ae[n + 48 >> 2] = 4096,
                            ae[n + 52 >> 2] = r.blocks,
                            ae[n + 56 >> 2] = 0 | r.atime.getTime() / 1e3,
                            ae[n + 60 >> 2] = 0,
                            ae[n + 64 >> 2] = 0 | r.mtime.getTime() / 1e3,
                            ae[n + 68 >> 2] = 0,
                            ae[n + 72 >> 2] = 0 | r.ctime.getTime() / 1e3,
                            ae[n + 76 >> 2] = 0,
                            tempI64 = [r.ino >>> 0, (tempDouble = r.ino,
                            1 <= +ke(tempDouble) ? 0 < tempDouble ? (0 | Fe(+ve(tempDouble / 4294967296), 4294967295)) >>> 0 : ~~+Ce((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)],
                            ae[n + 80 >> 2] = tempI64[0],
                            ae[n + 84 >> 2] = tempI64[1],
                            0
                        ...
                        doMsync: function(e, t, n, r) {
                            var o = new Uint8Array(ne.subarray(e, e + n));
                            Be.msync(t, o, 0, n, r)
                        },
                        doMkdir: function(e, t) {
                            return e = Pe.normalize(e),
                        ...
                        doAccess: function(e, t) {
                            ...
                            2 & t && (o += "w"),
                            1 & t && (o += "x"),
                            o && Be.nodePermissions(n, o) ? -13 : 0
                        },
                        doDup: function(e, t, n) {
                            var r = Be.getStream(n);
                            return r && Be.close(r),
                            Be.open(e, t, 0, n, n).fd
                        },
                        doReadv: function(e, t, n, r) {
                            for (var o = 0, a = 0; a < n; a++) {
                                var s = ae[t + 8 * a >> 2]
                                  , d = ae[t + (8 * a + 4) >> 2]
                                  , l = Be.read(e, te, s, d, r);
                                if (0 > l)
                                    return -1;
                                if (o += l,
                                l < d)
                    ...
                    var Me = G.asm({}, {
                        ...
                        m: function(e) {
                            ...
                            if (e > r)
                                return !1;
                            for (var o = W(t, 16777216); o < e; )
                                o = 536870912 >= o ? c(2 * o, n) : U(c((3 * o + 2147483648) / 4, n), r);
                            return !!O(o) && (g(),
                            !0)
                        },
                        l: function() {
        ...
        "/": [function(e, t) {
            ...
            class s extends HTMLElement {
                ...
                connectedCallback() {
                    ...
                    this.hasAttribute("baseUrl") || this.setAttribute("baseUrl", "https://bitmidi.com/timidity/"),
                ...
                _initPlayer() {
                    this.player = new r(this.baseUrl),
            ...
            window.customElements.define("bg-sound", s),
            t.exports = s,
                    ...
                    t.forEach(t => {
                        ...
                        !!n) {
                            ...
                            if (n.endsWith(".wav")) {
                                ...
                                e.controls = !1,
                                e.autoplay = !0,
                                r && ("infinite" === r.toLowerCase() || "true" === r || "-1" === r || 2 <= +r) && (e.loop = !0);
                                let t = !1;
